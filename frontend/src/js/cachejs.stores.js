...
var sessionStorageStore = function() {
    var prefix = "CacheJS_SS"; // change this if you're developing and want to kill everything ;0)

    var my = {
        has: function(key) {
            return (sessionStorage[prefix+key]!=null);
        },
        get: function(key) {
            if(!my.has(key)) {
                return undefined;
        ...
        set: function(key,val) {
            if(val===undefined) {
            	...
            	sessionStorage[prefix+key] = JSON.stringify(val);
            }
        },
        kill: function(key) {
    ...
    if(window.sessionStorage) {
        ...
        // sessionStorage not supported on this browser; degrade to arrayStore.
        return arrayStore();
    }
};
