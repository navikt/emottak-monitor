        ...
        <div className="App">
            ...
            <table>
                <tr>
                    ...
                    <th>
                        <Select label="Antall rader per side" value={pageSize} onChange={(size) => setPageSize(size.target.value)}>
                ...
                <tr>
                    <caption>
                        {antallMeldinger === 1? <p>1 melding</p>: <p>{antallMeldinger} meldinger</p> }
                    </caption>
                </tr>
            </table>
        </div>
